...
bamCoverage -b $OUTDIR/${filebase}_Chr1.bam -o $OUTDIR/${filebase}_Chr1.bw
bamCoverage -b $OUTDIR/${filebase}_Chr1PWS.bam -o $OUTDIR/${filebase}_Chr1PWS.bw
bamCoverage -b $OUTDIR/${filebase}_AEMK02000602.bam -o $OUTDIR/${filebase}_AEMK02000602.bw
